...
def main():
    ...
    parser.add_argument('--outline_model', type=str, default='gpt-5-mini', help='Model for outlining.')
    parser.add_argument('--content_model', type=str, default='gpt-5-mini', help='Model for content generation.')
