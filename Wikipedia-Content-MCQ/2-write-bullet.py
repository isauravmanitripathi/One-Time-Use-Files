...
class WikipediaEnhancementManager:
    ...
    def __init__(self, folder_path: str, model_name: str = "gpt-5-mini-2025-08-07", max_workers: int = None):
    ...
    def call_openai_api(self, content: str, chapter_name: str = "", section_name: str = "") -> Optional[List[str]]:
        ...
        user_prompt = f"""Create a detailed bullet point summary of the following content.{context_info}

REQUIREMENTS:
- Cover ALL key details, facts, statistics, dates, names, and concepts mentioned
- Don't suggest too many bullet points, focus on quality over quantity
...
Examples:
  ...
  python enhance_wikipedia_multi.py /path/to/json/folder --model gpt-5-mini-2025-08-07
